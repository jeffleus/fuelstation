...
//            return $resource(ApiEndpoint.url + 'Checkouts/Archived');
            return {
                query: function() {
                    return $http.get('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/checkouts/Archived'); 
                }
            };            
        }
        ...
        function _checkout() {
            ...
            return {
                save: function(checkout) {
                    return $http.post('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/checkouts',checkout);
                },
                update: function(checkout) {
                    return $http.put('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/checkouts',checkout);
                },
                delete: function(id) {
                    return $http.delete('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/checkouts/' + id);
                },
                get: function(id) {
                    return $http.get('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/checkouts/' + id);
                },
                query: function() {
                    return $http.get('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/checkouts?filter=93262,93263,93265,93266');
                }
            };
            return $http.post('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/checkouts',checkout)
        }
        ...
        function _getCheckoutHistory(id) {
            ...
            // });
            return $http.get('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/report/checkouts/history/' + id)
        ...
        function _getDailyCheckouts() {
			...
			return {
				query: function() {
					return $http.get('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/report/checkouts/daily');
				}
			}
        }
        ...
        */
        function _getMonthCounts(timePeriod){
            ...
            var reportUrl = 'https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/report/checkouts/monthly';
        ...
        */
        ...
        function _unarchived() {
            ...
            return {
                query: function() {
                    return $http.get('https://9pw80dg8i2.execute-api.us-west-2.amazonaws.com/prod/checkouts/Unarchived'); 
                }
            };            
        }
    });
