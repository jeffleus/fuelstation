(function () {
    ...
    .service('AccountSvc', function ($q, SnackLimits) {
        var self = this;
        self.daySnacksLimit = 3;
        self.monthSnacksLimit = 20;
        ...
        */
        ...
        function _initializeHiddenCategories(history, isUpdate) {
            if (history) {
                ...
                self.monthSnacksRemaining = Math.max(self.monthSnacksLimit - history.monthSnacksCount, 0) || 20;
                self.daySnacksRemaining = Math.max(self.daySnacksLimit - history.daySnacksCount, 0) || 3;
